...
class FSMMuxNode:
    ...
    def __init__(self):
        ...
        self.m3_force_base_duration = rospy.get_param("~m3_force_base_duration", 0.1)
        ...
        self.v2x_phase_time2    = rospy.get_param("~v2x_phase_time", 7.5)

        # 두 턴에 *각각* 쓰는 턴 지속 시간
        self.mission5_turn_duration = rospy.get_param("~mission5_turn_duration", 0)
        self.v2x_turn_duration      = rospy.get_param("~v2x_turn_duration", 1)
        ...
        self.v2x_turn_speed      = rospy.get_param("~v2x_turn_speed", 0.01)
        self.v2x_turn_yaw        = rospy.get_param("~v2x_turn_yaw", -0.06)
