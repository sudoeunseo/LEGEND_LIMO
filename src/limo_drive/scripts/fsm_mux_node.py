...
class FSMMuxNode:
    ...
    def __init__(self):
        ...
        self.m3_phase_time       = rospy.get_param("~m3_phase_time", 30.0)   # ★ 런치가 아니라 "첫 LKAS cmd 이후" 기준
        ...
        self.v2x_phase_time      = rospy.get_param("~v2x_phase_time", 11.0)
        self.v2x_turn_duration   = rospy.get_param("~v2x_turn_duration", 3.0)
